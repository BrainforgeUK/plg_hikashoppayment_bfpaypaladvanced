...
class JFormFieldBfpaypaladvancedhelp extends FormField
{
	protected $type = 'Bfpaypaladvancedhelp';
	...
	public static function configHelp($element=null)
	{
		...
		foreach (array(
					 'bfpaypaladvanced.pdf',
				 ) as $help) {
			$file = $locale . '.' . $help;
			if (!file_exists(__DIR__ . $file)) $file = 'en-GB.' . $help;
			$text[] = '<div style="height:3em;">';
			$text[] = '<a id="' . $help . '" href="' . $base . '/plugins/hikashoppayment/bfpaypaladvanced/help/' . $file . '" ' . 'target="bfpaypaladvanced-help" style="cursor:help;">';
